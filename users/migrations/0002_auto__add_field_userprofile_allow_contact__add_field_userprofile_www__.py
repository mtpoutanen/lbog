...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.allow_contact'
        db.add_column(u'users_userprofile', 'allow_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.www'
        db.add_column(u'users_userprofile', 'www',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.description'
        db.alter_column(u'users_userprofile', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000))

    def backwards(self, orm):
        # Deleting field 'UserProfile.allow_contact'
        db.delete_column(u'users_userprofile', 'allow_contact')

        # Deleting field 'UserProfile.www'
        db.delete_column(u'users_userprofile', 'www')


        # Changing field 'UserProfile.description'
        db.alter_column(u'users_userprofile', 'description', self.gf('django.db.models.fields.TextField')())
