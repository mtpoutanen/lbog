...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.time_created'
        db.add_column(u'projects_project', 'time_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 31, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.time_created'
        db.delete_column(u'projects_project', 'time_created')
