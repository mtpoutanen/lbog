...
The [issue tracker](https://github.com/harvesthq/mychosen/issues) is the 
...
1. **Use the [GitHub issue search](https://github.com/harvesthq/mychosen/search?type=Issues)** &mdash; check if the issue has already been
   reported.
...
If you're interested, you can find the task in [Gruntfile.coffee](https://github.com/harvesthq/mychosen/blob/master/Gruntfile.coffee).
