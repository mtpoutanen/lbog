...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.time_created'
        db.add_column(u'projects_request', 'time_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 22, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Request.time_created'
        db.delete_column(u'projects_request', 'time_created')
    ...
    models = {
        ...
        u'projects.request': {
            ...
            'seen_by_charity': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.UserProfile']"}),
            'time_accepted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
