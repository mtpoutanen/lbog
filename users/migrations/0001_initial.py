...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_userprofile', (
            ...
            ('user_type', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.State'])),
